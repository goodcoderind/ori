  ...
  return (
    <aside className="relative z-20 flex h-screen w-64 flex-col border-r border-white/10 glass-strong px-5 py-6 lg:w-64 md:w-20 md:px-3 md:py-5">
      ...
      <div className="mt-6 border-t border-borderSubtle pt-4">
        ...
        <button
          type="button"
          className="flex w-full items-center justify-center rounded-full glass border border-white/10 py-2 text-xs font-medium text-textMuted transition-all hover:border-accentViolet/50 hover:text-textPrimary hover:shadow-lg"
        >
          Export data
        </button>
      </div>
